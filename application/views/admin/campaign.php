      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="tambah-jadwal-sertifikasi" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-primary btn-xs"
                          onclick="window.location.href = '<?php echo base_url() ?>edit-jadwal-sertifikasi/<?php echo $key['id'] ?>/jadwal-sertifikasi'"><i
                            class="fa fa-edit"></i></button>
                        <button class="btn btn-danger btn-xs"
                          onclick="hapus('<?php echo base_url() ?>hapus-jadwal-sertifikasi/<?php echo $key['id'] ?>/jadwal-sertifikasi');"><i
