...
<?php foreach ($content2->result_array() as $key): ?>
        ...
        <div class="row">
          <div class="col-lg-12 col-12 text-left">
            ...
            <div class="col-lg-9 col-9 text-left row">
              ...
              <input type="number" class="modal-title" id="price2">
              <!-- <p class="modal-title" id="modal-price3"></p> -->
            </div>
            <br>
            <div class="col-lg-9 col-9 text-left row">
              <p class="modal-title">Gift: Rp.&nbsp </p>
            ...
            <div class="col-lg-9 col-9 text-left row">
              <p class="modal-title">Gift: Rp.&nbsp </p>
              <p class="modal-title" id="modal-giftt"></p>
            </div>
            <hr>
            <div class="col-lg-9 col-9 text-left row">
  ...
  <script type="text/javascript">
    ...
    $('[data-toggle="modal"]').on('click', function (e) {
      ...
      window.eventName = document.getElementById('modal-packagename').innerHTML;
    ...
    document.getElementById('pay-button3').onclick = function () {
      var eventName2 = document.getElementById('modal-packagename').innerHTML;
